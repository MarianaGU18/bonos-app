  ...
  return (
    ...
    >
      <Stack direction="row" spacing={1.2} alignItems="center">
        <Box sx={{ color: "#7FB3D5", display: "grid", placeItems: "center" }}>
          {icon}
        </Box>
        <Box sx={{ minWidth: 0 }}>
          <Typography sx={{ color: "#1F2937", fontSize: 12, fontWeight: 850 }}>
            {label}
          </Typography>
          <Typography
            sx={{ color: "#1F2937", fontWeight: 900, overflowWrap: "anywhere" }}
          >
            {value}
          </Typography>
        </Box>
        ...
        >
          ...
          >
            ...
            >
              ...
              <Typography
                sx={{ fontSize: 28, lineHeight: 1.08, fontWeight: 950 }}
              >
            ...
            <Stack spacing={1.2} sx={{ p: 2.2 }}>
              ...
              <InfoTile
                ...
                value={formData.birthdate || "No especificada"}
              />
              <InfoTile
              ...
              >
                <Box>
                  ...
                  <Typography sx={{ mt: 1.4, color: "#1F2937", maxWidth: 680 }}>
                    Administra datos personales de tu cuenta financiera.
                  </Typography>
                </Box>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                >
                  <Box>
                    ...
                    <Typography sx={{ color: "#1F2937", mt: 0.5 }}>
                      Mantén tus datos de identificacion actualizados.
                    </Typography>
                  </Box>
                  {!isEditing && (
                    <Button
